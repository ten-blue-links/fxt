...
int main(int argc, char **argv) {
    ...
    CLI::App app;
    app.add_option("query_file", query_file, "Query file")->required()->check(CLI::ExistingFile);
    app.add_option("trec_file", trec_file, "TREC run file")->required()->check(CLI::ExistingFile);
    ...
    app.add_option("--forward_index", fwd_index_file, "Path to a forward index file")
        ->required()
        ->check(CLI::ExistingFile);
    app.add_option("--lexicon", lexicon_file, "Path to a lexicon file")
        ->required()
        ->check(CLI::ExistingFile);
    app.add_option("--static_doc_file", static_doc_file, "Path to a static document feature file")
        ->required()
        ->check(CLI::ExistingFile);
    ...
    app.add_flag(
        ...
        ->group("Query-document features");
    app.add_flag("--f_bm25_atire", query_doc_flags.f_bm25_atire, "Enable feature f_bm25_atire")
        ->group("Query-document features");
    app.add_flag("--f_bm25_atire_body",
                 query_doc_flags.f_bm25_atire_body,
                 "Enable feature f_bm25_atire_body")
        ->group("Query-document features");
    app.add_flag("--f_bm25_atire_title",
                 query_doc_flags.f_bm25_atire_title,
                 "Enable feature f_bm25_atire_title")
        ->group("Query-document features");
    app.add_flag("--f_bm25_atire_heading",
                 query_doc_flags.f_bm25_atire_heading,
                 "Enable feature f_bm25_atire_heading")
        ->group("Query-document features");
    app.add_flag("--f_bm25_atire_inlink",
                 query_doc_flags.f_bm25_atire_inlink,
                 "Enable feature f_bm25_atire_inlink")
        ->group("Query-document features");
    app.add_flag(
           "--f_bm25_atire_a", query_doc_flags.f_bm25_atire_a, "Enable feature f_bm25_atire_a")
        ->group("Query-document features");
    app.add_flag("--f_bm25_trec3", query_doc_flags.f_bm25_trec3, "Enable feature f_bm25_trec3")
        ->group("Query-document features");
    app.add_flag("--f_bm25_trec3_body",
                 query_doc_flags.f_bm25_trec3_body,
                 "Enable feature f_bm25_trec3_body")
        ->group("Query-document features");
    app.add_flag("--f_bm25_trec3_title",
                 query_doc_flags.f_bm25_trec3_title,
                 "Enable feature f_bm25_trec3_title")
        ->group("Query-document features");
    app.add_flag("--f_bm25_trec3_heading",
                 query_doc_flags.f_bm25_trec3_heading,
                 "Enable feature f_bm25_trec3_heading")
        ->group("Query-document features");
    app.add_flag("--f_bm25_trec3_inlink",
                 query_doc_flags.f_bm25_trec3_inlink,
                 "Enable feature f_bm25_trec3_inlink")
        ->group("Query-document features");
    app.add_flag(
           "--f_bm25_trec3_a", query_doc_flags.f_bm25_trec3_a, "Enable feature f_bm25_trec3_a")
        ->group("Query-document features");
    app.add_flag("--f_bm25_trec3_kmax",
                 query_doc_flags.f_bm25_trec3_kmax,
    ...
    app.add_flag("--f_bm25_trec3_kmax_inlink",
        ...
        ->group("Query-document features");
    app.add_flag("--f_bm25_trec3_kmax_a",
                 query_doc_flags.f_bm25_trec3_kmax_a,
                 "Enable feature f_bm25_trec3_kmax_a")
        ->group("Query-document features");
    app.add_flag("--f_lm_dir_2500", query_doc_flags.f_lm_dir_2500, "Enable feature f_lm_dir_2500")
        ->group("Query-document features");
    app.add_flag("--f_lm_dir_2500_body",
                 query_doc_flags.f_lm_dir_2500_body,
                 "Enable feature f_lm_dir_2500_body")
        ->group("Query-document features");
    app.add_flag("--f_lm_dir_2500_title",
                 query_doc_flags.f_lm_dir_2500_title,
                 "Enable feature f_lm_dir_2500_title")
        ->group("Query-document features");
    app.add_flag("--f_lm_dir_2500_heading",
                 query_doc_flags.f_lm_dir_2500_heading,
                 "Enable feature f_lm_dir_2500_heading")
        ->group("Query-document features");
    app.add_flag("--f_lm_dir_2500_inlink",
                 query_doc_flags.f_lm_dir_2500_inlink,
                 "Enable feature f_lm_dir_2500_inlink")
        ->group("Query-document features");
    app.add_flag(
           "--f_lm_dir_2500_a", query_doc_flags.f_lm_dir_2500_a, "Enable feature f_lm_dir_2500_a")
        ->group("Query-document features");
    app.add_flag("--f_lm_dir_1500", query_doc_flags.f_lm_dir_1500, "Enable feature f_lm_dir_1500")
        ->group("Query-document features");
    app.add_flag("--f_lm_dir_1500_body",
                 query_doc_flags.f_lm_dir_1500_body,
                 "Enable feature f_lm_dir_1500_body")
        ->group("Query-document features");
    app.add_flag("--f_lm_dir_1500_title",
                 query_doc_flags.f_lm_dir_1500_title,
                 "Enable feature f_lm_dir_1500_title")
        ->group("Query-document features");
    app.add_flag("--f_lm_dir_1500_heading",
                 query_doc_flags.f_lm_dir_1500_heading,
                 "Enable feature f_lm_dir_1500_heading")
        ->group("Query-document features");
    app.add_flag("--f_lm_dir_1500_inlink",
                 query_doc_flags.f_lm_dir_1500_inlink,
                 "Enable feature f_lm_dir_1500_inlink")
        ->group("Query-document features");
    app.add_flag(
           "--f_lm_dir_1500_a", query_doc_flags.f_lm_dir_1500_a, "Enable feature f_lm_dir_1500_a")
        ->group("Query-document features");
    app.add_flag("--f_lm_dir_1000", query_doc_flags.f_lm_dir_1000, "Enable feature f_lm_dir_1000")
        ->group("Query-document features");
    app.add_flag("--f_lm_dir_1000_body",
                 query_doc_flags.f_lm_dir_1000_body,
                 "Enable feature f_lm_dir_1000_body")
        ->group("Query-document features");
    app.add_flag("--f_lm_dir_1000_title",
                 query_doc_flags.f_lm_dir_1000_title,
                 "Enable feature f_lm_dir_1000_title")
        ->group("Query-document features");
    app.add_flag("--f_lm_dir_1000_heading",
                 query_doc_flags.f_lm_dir_1000_heading,
                 "Enable feature f_lm_dir_1000_heading")
        ->group("Query-document features");
    app.add_flag("--f_lm_dir_1000_inlink",
                 query_doc_flags.f_lm_dir_1000_inlink,
                 "Enable feature f_lm_dir_1000_inlink")
        ->group("Query-document features");
    app.add_flag(
           "--f_lm_dir_1000_a", query_doc_flags.f_lm_dir_1000_a, "Enable feature f_lm_dir_1000_a")
        ->group("Query-document features");
    app.add_flag("--f_tfidf", query_doc_flags.f_tfidf, "Enable feature f_tfidf")
        ->group("Query-document features");
    app.add_flag("--f_tfidf_body", query_doc_flags.f_tfidf_body, "Enable feature f_tfidf_body")
        ->group("Query-document features");
    app.add_flag("--f_tfidf_title", query_doc_flags.f_tfidf_title, "Enable feature f_tfidf_title")
        ->group("Query-document features");
    app.add_flag(
           "--f_tfidf_heading", query_doc_flags.f_tfidf_heading, "Enable feature f_tfidf_heading")
        ->group("Query-document features");
    app.add_flag(
           "--f_tfidf_inlink", query_doc_flags.f_tfidf_inlink, "Enable feature f_tfidf_inlink")
        ->group("Query-document features");
    app.add_flag("--f_tfidf_a", query_doc_flags.f_tfidf_a, "Enable feature f_tfidf_a")
        ->group("Query-document features");
    app.add_flag("--f_prob", query_doc_flags.f_prob, "Enable feature f_prob")
        ->group("Query-document features");
    app.add_flag("--f_prob_body", query_doc_flags.f_prob_body, "Enable feature f_prob_body")
        ->group("Query-document features");
    app.add_flag("--f_prob_title", query_doc_flags.f_prob_title, "Enable feature f_prob_title")
        ->group("Query-document features");
    app.add_flag(
           "--f_prob_heading", query_doc_flags.f_prob_heading, "Enable feature f_prob_heading")
        ->group("Query-document features");
    app.add_flag("--f_prob_inlink", query_doc_flags.f_prob_inlink, "Enable feature f_prob_inlink")
        ->group("Query-document features");
    app.add_flag("--f_prob_a", query_doc_flags.f_prob_a, "Enable feature f_prob_a")
        ->group("Query-document features");
    app.add_flag("--f_be", query_doc_flags.f_be, "Enable feature f_be")
        ->group("Query-document features");
    app.add_flag("--f_be_body", query_doc_flags.f_be_body, "Enable feature f_be_body")
        ->group("Query-document features");
    app.add_flag("--f_be_title", query_doc_flags.f_be_title, "Enable feature f_be_title")
        ->group("Query-document features");
    app.add_flag("--f_be_heading", query_doc_flags.f_be_heading, "Enable feature f_be_heading")
        ->group("Query-document features");
    app.add_flag("--f_be_inlink", query_doc_flags.f_be_inlink, "Enable feature f_be_inlink")
        ->group("Query-document features");
    ...
    app.add_flag("--f_dph", query_doc_flags.f_dph, "Enable feature f_dph")
        ->group("Query-document features");
    app.add_flag("--f_dph_body", query_doc_flags.f_dph_body, "Enable feature f_dph_body")
        ->group("Query-document features");
    app.add_flag("--f_dph_title", query_doc_flags.f_dph_title, "Enable feature f_dph_title")
        ->group("Query-document features");
    app.add_flag("--f_dph_heading", query_doc_flags.f_dph_heading, "Enable feature f_dph_heading")
        ->group("Query-document features");
    app.add_flag("--f_dph_inlink", query_doc_flags.f_dph_inlink, "Enable feature f_dph_inlink")
        ->group("Query-document features");
    ...
    app.add_flag("--f_dfr", query_doc_flags.f_dfr, "Enable feature f_dfr")
        ->group("Query-document features");
    app.add_flag("--f_dfr_body", query_doc_flags.f_dfr_body, "Enable feature f_dfr_body")
        ->group("Query-document features");
    app.add_flag("--f_dfr_title", query_doc_flags.f_dfr_title, "Enable feature f_dfr_title")
        ->group("Query-document features");
    app.add_flag("--f_dfr_heading", query_doc_flags.f_dfr_heading, "Enable feature f_dfr_heading")
        ->group("Query-document features");
    app.add_flag("--f_dfr_inlink", query_doc_flags.f_dfr_inlink, "Enable feature f_dfr_inlink")
        ->group("Query-document features");
    app.add_flag("--f_dfr_a", query_doc_flags.f_dfr_a, "Enable feature f_dfr_a")
        ->group("Query-document features");
    app.add_flag("--f_stream_len", query_doc_flags.f_stream_len, "Enable feature f_stream_len")
        ->group("Query-document features");
    app.add_flag("--f_stream_len_body",
                 query_doc_flags.f_stream_len_body,
                 "Enable feature f_stream_len_body")
        ->group("Query-document features");
    app.add_flag("--f_stream_len_title",
                 query_doc_flags.f_stream_len_title,
                 "Enable feature f_stream_len_title")
        ->group("Query-document features");
    app.add_flag("--f_stream_len_heading",
                 query_doc_flags.f_stream_len_heading,
                 "Enable feature f_stream_len_heading")
        ->group("Query-document features");
    app.add_flag("--f_stream_len_inlink",
                 query_doc_flags.f_stream_len_inlink,
                 "Enable feature f_stream_len_inlink")
        ->group("Query-document features");
    app.add_flag(
           "--f_stream_len_a", query_doc_flags.f_stream_len_a, "Enable feature f_stream_len_a")
        ->group("Query-document features");
    app.add_flag("--f_sum_stream_len",
                 query_doc_flags.f_sum_stream_len,
                 "Enable feature f_sum_stream_len")
        ->group("Query-document features");
    app.add_flag("--f_sum_stream_len_body",
                 query_doc_flags.f_sum_stream_len_body,
    ...
    app.add_flag("--f_sum_stream_len_inlink",
        ...
        ->group("Query-document features");
    app.add_flag("--f_sum_stream_len_a",
                 query_doc_flags.f_sum_stream_len_a,
                 "Enable feature f_sum_stream_len_a")
        ->group("Query-document features");
    app.add_flag("--f_min_stream_len",
                 query_doc_flags.f_min_stream_len,
                 "Enable feature f_min_stream_len")
        ->group("Query-document features");
    app.add_flag("--f_min_stream_len_body",
                 query_doc_flags.f_min_stream_len_body,
    ...
    app.add_flag("--f_min_stream_len_inlink",
        ...
        ->group("Query-document features");
    app.add_flag("--f_min_stream_len_a",
                 query_doc_flags.f_min_stream_len_a,
                 "Enable feature f_min_stream_len_a")
        ->group("Query-document features");
    app.add_flag("--f_max_stream_len",
                 query_doc_flags.f_max_stream_len,
                 "Enable feature f_max_stream_len")
        ->group("Query-document features");
    app.add_flag("--f_max_stream_len_body",
                 query_doc_flags.f_max_stream_len_body,
    ...
    app.add_flag("--f_max_stream_len_inlink",
        ...
        ->group("Query-document features");
    app.add_flag("--f_max_stream_len_a",
                 query_doc_flags.f_max_stream_len_a,
                 "Enable feature f_max_stream_len_a")
        ->group("Query-document features");
    app.add_flag("--f_mean_stream_len",
                 query_doc_flags.f_mean_stream_len,
    ...
    app.add_flag("--f_mean_stream_len_inlink",
        ...
        ->group("Query-document features");
    app.add_flag("--f_mean_stream_len_a",
                 query_doc_flags.f_mean_stream_len_a,
                 "Enable feature f_mean_stream_len_a")
        ->group("Query-document features");
    app.add_flag("--f_variance_stream_len",
                 query_doc_flags.f_variance_stream_len,
    ...
    app.add_flag("--f_variance_stream_len_a",
        ...
        ->group("Query-document features");
    app.add_flag("--f_tpscore", query_doc_flags.f_tpscore, "Enable feature f_tpscore")
        ->group("Query-document features");
    app.add_flag("--f_bm25_bigram_u8",
                 query_doc_flags.f_bm25_bigram_u8,
                 "Enable feature f_bm25_bigram_u8")
        ->group("Query-document features");
    app.add_flag("--f_bm25_tp_dist_w100",
                 query_doc_flags.f_bm25_tp_dist_w100,
                 "Enable feature f_bm25_tp_dist_w100")
        ->group("Query-document features");
    app.add_flag("--f_tag_title_qry_count",
                 query_doc_flags.f_tag_title_qry_count,
    ...
    app.add_flag("--f_tag_inlink_qry_count",
        ...
        ->group("Query-document features");
    app.add_flag("--f_tag_title_count",
                 query_doc_flags.f_tag_title_count,
                 "Enable feature f_tag_title_count")
        ->group("Query-document features");
    app.add_flag("--f_tag_heading_count",
                 query_doc_flags.f_tag_heading_count,
                 "Enable feature f_tag_heading_count")
        ->group("Query-document features");
    app.add_flag("--f_tag_inlink_count",
                 query_doc_flags.f_tag_inlink_count,
                 "Enable feature f_tag_inlink_count")
        ->group("Query-document features");
    app.add_flag("--f_tag_applet_count",
                 query_doc_flags.f_tag_applet_count,
                 "Enable feature f_tag_applet_count")
        ->group("Query-document features");
    app.add_flag("--f_tag_object_count",
                 query_doc_flags.f_tag_object_count,
                 "Enable feature f_tag_object_count")
        ->group("Query-document features");
    app.add_flag("--f_tag_embed_count",
    ...
    app.add_flag("--f_title_len", static_doc_flags.f_title_len, "Enable feature f_title_len")
        ->group("Static document features");
    app.add_flag("--f_visterm_len", static_doc_flags.f_visterm_len, "Enable feature f_visterm_len")
        ->group("Static document features");
    app.add_flag("--f_url_len", static_doc_flags.f_url_len, "Enable feature f_url_len")
        ->group("Static document features");
    app.add_flag("--f_url_depth", static_doc_flags.f_url_depth, "Enable feature f_url_depth")
        ->group("Static document features");
    app.add_flag(
           "--f_avg_term_len", static_doc_flags.f_avg_term_len, "Enable feature f_avg_term_len")
        ->group("Static document features");
    app.add_flag("--f_entropy", static_doc_flags.f_entropy, "Enable feature f_entropy")
        ->group("Static document features");
    app.add_flag("--f_stop_cover", static_doc_flags.f_stop_cover, "Enable feature f_stop_cover")
        ->group("Static document features");
    app.add_flag("--f_frac_stop", static_doc_flags.f_frac_stop, "Enable feature f_frac_stop")
        ->group("Static document features");
    app.add_flag("--f_frac_anchor_text",
                 static_doc_flags.f_frac_anchor_text,
                 "Enable feature f_frac_anchor_text")
        ->group("Static document features");
    app.add_flag(
           "--f_frac_vis_text", static_doc_flags.f_frac_vis_text, "Enable feature f_frac_vis_text")
        ->group("Static document features");
    app.add_flag("--f_frac_table_text",
                 static_doc_flags.f_frac_table_text,
