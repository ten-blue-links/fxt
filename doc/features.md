...
|-------------|-----------------------------|
| 131         | Query length                |
| 132         | Query length non-stop words |
| 133         | Simplified clarity score    |
| 134         | Query scope score           |
| 135         | TF.IDF average              |
| 136         | TF.IDF variance             |
| 137         | TF.IDF standard deviation   |
| 138         | TF.IDF confidence           |
| 139         | Gamma2: IDF max / IDF min   |
| 140         | Average IDF on full query   |
| 141         | Average IDF non-stop words  |
| 142         | Average ICTF on full query  |
| 143         | Average ICTF non-stop words |
