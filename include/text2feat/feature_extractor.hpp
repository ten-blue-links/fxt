...
class FeatureExtractor {
   ...
   public:
    FeatureExtractor(Lexicon &lex, FieldIdMap &fid, doc_entry_flag &qdf, statdoc_entry_flag &sdf)
        : lexicon(lex),
          fid_map(fid),
          qd_flags(qdf),
          sd_flags(sdf),
    ...
    inline bool has_bm25_atire() {
        return qd_flags.f_bm25_atire || qd_flags.f_bm25_atire_body || qd_flags.f_bm25_atire_title ||
               qd_flags.f_bm25_atire_heading || qd_flags.f_bm25_atire_inlink ||
               qd_flags.f_bm25_atire_a;
    }

    inline bool has_bm25_trec3() {
        return qd_flags.f_bm25_trec3 || qd_flags.f_bm25_trec3_body || qd_flags.f_bm25_trec3_title ||
               qd_flags.f_bm25_trec3_heading || qd_flags.f_bm25_trec3_inlink ||
               qd_flags.f_bm25_trec3_a;
    }

    inline bool has_bm25_trec3_kmax() {
        return qd_flags.f_bm25_trec3_kmax || qd_flags.f_bm25_trec3_kmax_body ||
               qd_flags.f_bm25_trec3_kmax_title || qd_flags.f_bm25_trec3_kmax_heading ||
    ...
    inline bool has_tfidf() {
        return qd_flags.f_tfidf || qd_flags.f_tfidf_body || qd_flags.f_tfidf_title ||
               qd_flags.f_tfidf_heading || qd_flags.f_tfidf_inlink || qd_flags.f_tfidf_a;
    }

    inline bool has_prob() {
        return qd_flags.f_prob || qd_flags.f_prob_body || qd_flags.f_prob_title ||
               qd_flags.f_prob_heading || qd_flags.f_prob_inlink || qd_flags.f_prob_a;
    }
    ...
    inline bool has_stream() {
        return has_stream_len() || has_sum_stream_len() || has_min_stream_len() ||
               has_max_stream_len() || has_mean_stream_len() || has_variance_stream_len();
    }

    inline bool has_stream_len() {
        return qd_flags.f_stream_len || qd_flags.f_stream_len_body || qd_flags.f_stream_len_title ||
               qd_flags.f_stream_len_heading || qd_flags.f_stream_len_inlink ||
               qd_flags.f_stream_len_a;
    }

    inline bool has_sum_stream_len() {
        return qd_flags.f_sum_stream_len || qd_flags.f_sum_stream_len_body ||
               qd_flags.f_sum_stream_len_title || qd_flags.f_sum_stream_len_heading ||
    ...
    inline bool has_min_stream_len() {
        return qd_flags.f_min_stream_len || qd_flags.f_min_stream_len_body ||
               qd_flags.f_min_stream_len_title || qd_flags.f_min_stream_len_heading ||
    ...
    inline bool has_max_stream_len() {
        return qd_flags.f_max_stream_len || qd_flags.f_max_stream_len_body ||
               qd_flags.f_max_stream_len_title || qd_flags.f_max_stream_len_heading ||
    ...
    inline bool has_mean_stream_len() {
        return qd_flags.f_mean_stream_len || qd_flags.f_mean_stream_len_body ||
               qd_flags.f_mean_stream_len_title || qd_flags.f_mean_stream_len_heading ||
               qd_flags.f_mean_stream_len_inlink || qd_flags.f_mean_stream_len_a;
    }

    inline bool has_variance_stream_len() {
        return qd_flags.f_variance_stream_len || qd_flags.f_variance_stream_len_body ||
               qd_flags.f_variance_stream_len_title || qd_flags.f_variance_stream_len_heading ||
               qd_flags.f_variance_stream_len_inlink || qd_flags.f_variance_stream_len_a;
    }
